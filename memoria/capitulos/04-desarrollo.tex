...
\begin{table}[H]
\centering
\caption{Análisis de varianza de las seis componentes de \texttt{deck\_quality} sobre los 40 mazos finales de \texttt{prueba2} (gen 30). CoV $<$ 10\,\% indica saturación.}
...
\begin{table}[H]
\centering
\caption{Parámetros del run final (\texttt{presentacionProfes}).}
