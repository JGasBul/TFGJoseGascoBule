...
El problema de la monocultura cromática se abordó de otra forma: el run definitivo (§4.4) se ejecutó con múltiples semillas y sin gauntlet, aceptando que cada ejecución converge a un par cromático y documentando ese comportamiento como un límite del sistema. El ecosistema completo de arquetipos requeriría varias ejecuciones con puntos de partida distintos, lo que se propone como línea de trabajo futuro.
