...
Este capítulo documenta cómo el sistema descrito en la metodología llegó a su forma actual y qué evidencia sostiene cada decisión de diseño. Empieza por la evolución del proyecto, desde el primer prototipo hasta el sistema maduro, y continúa con los experimentos que validan los cambios: la comparativa que justifica los operadores pack-aware, el refinamiento de la métrica de calidad, el run más extenso con el sistema completo y una vía que se exploró y se descartó.

\section{Del prototipo al diseño actual}
\label{sec:evolucion}

El sistema descrito en el capítulo anterior no es el que se construyó al principio. Es el resultado de varias iteraciones, cada una motivada por un problema concreto que el run anterior dejó al descubierto. Merece la pena recorrer ese camino, porque las decisiones de diseño que definen el sistema actual solo se entienden a la luz de lo que vino antes y de por qué no funcionaba.
...
El pico absoluto, 0,9755, aparece en la generación 42, la última del run. Ese dato tiene una lectura favorable: el algoritmo seguía mejorando al momento de la terminación. Con más generaciones, el gradiente existente permitiría previsiblemente superar ese valor. La figura~\ref{fig:fitness} muestra la trayectoria completa del mejor individuo y de la media de la población.

\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{images/fig_evolucion_fitness.pdf}
\caption{Evolución del fitness del run final. El mejor de cada generación fluctúa por el ruido de la evaluación por simulación, mientras la media asciende de forma sostenida. El pico de 0,9755 se alcanza en la última generación.}
\label{fig:fitness}
\end{figure}
...
El mazo con la fitness más alta del Hall of Fame, y por tanto el campeón del run, es el R/W con 0,9755 que el detector de arquetipos clasifica como control:
...
El mazo es competitivo con el estándar del formato. Un jugador con experiencia en R/W reconocería el plan de quemado y no necesitaría cambios estructurales para llevarlo a un torneo.
