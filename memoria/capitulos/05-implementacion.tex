...
Este capítulo describe cómo se ha realizado en código la propuesta del capítulo anterior: las tecnologías empleadas, la estructura del proyecto y los aspectos técnicos que hacen viable la evaluación por simulación.
...
\begin{itemize}
    ...
    \item \texttt{algoritmo\_genetico\_mtg.py} concentra el núcleo del sistema. La clase \texttt{MTGGeneticAlgorithm} encapsula el ciclo evolutivo completo: inicialización, evaluación, selección, cruce, mutación, elitismo y persistencia.
...
El proyecto se mantiene bajo control de versiones con Git, en un repositorio accesible en línea \faltaref{URL del repositorio de Git del proyecto}.
...
Al término de cada generación, el sistema guarda un punto de control con el estado de la población, el Hall of Fame y las estadísticas de la ejecución. Esta persistencia cumple dos funciones: permite reanudar un run interrumpido sin repetir el cómputo ya realizado y, sobre todo, hace posible reconstruir a posteriori la trayectoria de cada experimento, lo que sustenta el análisis del capítulo siguiente. Para disputar cada partida, el fenotipo de un mazo se traduce al archivo de mazo (\texttt{.dck}) que Forge lee, de modo que cada individuo evaluado queda también almacenado en un formato reutilizable.
