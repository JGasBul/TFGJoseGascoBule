...
Este capítulo describe la metodología de trabajo seguida para desarrollar el proyecto, entendida como el proceso y las herramientas empleadas a lo largo del mismo. La propuesta técnica, esto es, el sistema diseñado e implementado, se detalla en el capítulo~\ref{sec:arquitectura}.
...
Cada iteración constó de cuatro pasos: la implementación de un cambio en el sistema, la ejecución de un experimento sobre el código resultante, el análisis de los datos obtenidos y la decisión del siguiente cambio a partir de esos hallazgos. Este ciclo de mejora basado en evidencia es el que vertebra la evolución del proyecto, desde el primer prototipo hasta el sistema definitivo, y se documenta en detalle en el capítulo~\ref{cap:desarrollo}.
...
\begin{enumerate}
    ...
    \item \textbf{Ciclos de experimentación.} Núcleo del trabajo. Ejecución sucesiva de experimentos, cada uno orientado a validar o refutar una decisión de diseño concreta, con el análisis de sus resultados guiando la siguiente iteración.
...
\begin{itemize}
    \item \textbf{Mejor fitness y fitness medio}: el valor del mejor individuo y la media de la población en cada generación. El primero mide el techo alcanzado; el segundo, el nivel general de la población y su progresión.
