...
Este capítulo documenta el proceso experimental que validó la propuesta y qué evidencia sostiene cada decisión de diseño. Empieza por la evolución del proyecto, desde el primer prototipo hasta el sistema maduro, y continúa con los experimentos que validan los cambios: la comparativa que justifica los operadores pack-aware, el refinamiento de la métrica de calidad, el run más extenso con el sistema completo y una vía que se exploró y se descartó.
