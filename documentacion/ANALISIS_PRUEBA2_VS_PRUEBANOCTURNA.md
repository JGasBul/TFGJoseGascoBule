# Análisis comparativo: `prueba2/` (pack-aware) vs `pruebaNocturna/` (baseline)
...
| | `pruebaNocturna/` (baseline) | `prueba2/` (pack-aware) |
|---|---|---|
...
| Métrica | `pruebaNocturna` | `prueba2` |
|---|---:|---:|
...
| Ventana (gens 19-30) | baseline | prueba2 |
|---|---:|---:|
...
Evolución completa visible en `prueba2/parallel_evolution_stats.csv` (31 líneas):
...
- `stagnation_counter` al final de prueba2 = 9 → el run se cerró cerca del plateau. Con más gens podría romperlo.
...
| | baseline (pruebaNocturna) | pack-aware (prueba2) |
|---|---|---|
...
**pack-aware `hall_of_fame_midrange_1.dck`** (el mejor de prueba2):
```
...
El `mutation_rate` subió a 0.9 en gens 14-18 (detectó estancamiento), relajó a 0.60/0.75. Funciona, pero el `stagnation_counter=9` al final de prueba2 indica que las últimas 9 gens no superaron el pico de gen 20. El pico está conservado en el HOF.
...
El run `prueba2/` **valida las Fases 1 / 2 / 2.5** del plan de mutación y crossover a nivel de pack:
...
**prueba2/:**
- Stats evolutivos: [prueba2/parallel_evolution_stats.csv](../prueba2/parallel_evolution_stats.csv), [prueba2/parallel_evolution_stats.png](../prueba2/parallel_evolution_stats.png)
- Población final: [prueba2/final_population_20260424_152946.json](../prueba2/final_population_20260424_152946.json)
- Hall of Fame top-5 consolidado: [prueba2/parallel_hall_of_fame.json](../prueba2/parallel_hall_of_fame.json)
- 9 HOF por arquetipo (.dck + .json): [prueba2/hall_of_fame/](../prueba2/hall_of_fame/)
- Mejor mazo: [prueba2/best_deck_final_parallel.json](../prueba2/best_deck_final_parallel.json)
- Log ejecución: [prueba2/logs/parallel_ag_execution_20260421_202441.log](../prueba2/logs/parallel_ag_execution_20260421_202441.log)
- Stats por gen: [prueba2/logs/parallel_generation_statistics.json](../prueba2/logs/parallel_generation_statistics.json)

**pruebaNocturna/:**
- Stats evolutivos (parciales): [pruebaNocturna/parallel_evolution_stats.csv](../pruebaNocturna/parallel_evolution_stats.csv)
- Población final: [pruebaNocturna/final_population_20260420_124847.json](../pruebaNocturna/final_population_20260420_124847.json)
- Hall of Fame top-5: [pruebaNocturna/parallel_hall_of_fame.json](../pruebaNocturna/parallel_hall_of_fame.json)
- HOF por arquetipo: [pruebaNocturna/hall_of_fame/](../pruebaNocturna/hall_of_fame/)
